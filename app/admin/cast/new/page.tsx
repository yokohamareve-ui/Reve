  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold text-[#d4af37]">新規キャスト作成</h1>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setForm((p) => ({
                    ...p,
                    name,
                    slug: slugManuallyEdited ? p.slug : generateSlug(name),
                  }));
                }}
                required
            ...
            <div>
              <label className="block text-xs font-medium text-[#c8a830] mb-1">
                スラッグ *
                <span className="ml-1 font-normal text-[#6a5518]">（自動生成）</span>
              </label>
              <input
                type="text"
                value={form.slug}
